...
const Navbar = () => {
  ...
  return (
    <div className="bg-priary flex items-center justify-between py-5  text-white ">
      ...
      <div className="flex items-center justify-center gap-4 Xlarge:hidden ">
      ...
      <div className="flex items-center justify-end gap-8 tablet:hidden ">
        <p className="hf tablet:hidden border-b border-b-[white] cursor-pointer text-base">
          Login
        </p>
        <FancyButton accent="dark" text="Signup" />
        {/* <div
          className="flex items-center tablet:hidden justify-center rounded-full p-[1px]  "
          style={{
            background: "linear-gradient(137deg, #80fcf0 0%, #ac5dfa 100%)",
          }}
        >
          <button
            className="rounded-full px-8 py-3 fancyBtn bg-primary text-base"
            id="fancyBtn"
          >
            Signup
          </button>
