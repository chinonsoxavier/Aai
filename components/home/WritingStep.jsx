...
// const WritingStep = () => {
//   return (
//     <div className="text-white mt-20 flex items-center justify-cemter w-full flex-col">
//       <div className="flex items-center justify-center px-[4vw]">
//         <div className="flex items-center justify-cemter w-full max-w-[75rem] bg-[#111629]  border border-[rgba(255,255,255,0.12)]   rounded-[30px]">
//           <div className=" px-16 Xlarge:px-10 flex items-center justify-between">
//             <div className="grid grid-cols-3 items-start justify-center gap-20 bg-[] h-full ">
//               <div className="bg-[] h-full flex items-center justify-between border-r border-r-[rgba(255,255,255,0.12)] py-12 pr-16 relative">
//                 <div className="">
//                   <svg
//                     className="w-9 h-9 "
//                     viewBox="0 0 36 36"
...
//                     </defs>
//                   </svg>
//                   <p className="f font-bold text-2xl my-6 large:my-3 large:text-xl">
//                     Select writing template
//                   </p>

//                   <p className="f text-lg font-normal text-[#747681] large:text-base">
//                     Simply choose a template from available list to write
//                     content.
//                   </p>
//                 </div>

//                 <div className="flex items-center justify-center bg-primary absolute -right-6 rounded-full w-12 h-12 border border-[rgba(255,255,255,0.12)]">
//                   <svg
//                     width="13"
//                     height="20"
//                     viewBox="0 0 13 20"
...
//                 </div>
//               </div>
//               <div className="bg-[]  flex items-center justify-between border-r border-r-[rgba(255,255,255,0.12)] py-12 pr-16 relative">
//                 <div className="">
//                   <svg
//                     className="w-9 h-9"
//                     viewBox="0 0 32 34"
...
//               {/* <div className="flex items-center justify-between border-r border-r-[rgba(255,255,255,0.12)] py-12 pr-16 relative">
//                 <div className="">
//                   <svg
//                     className="w-9 h-9 "
//                     viewBox="0 0 32 34"
...
//               <div className="flex items-center justify-between  py-12 pr-16 relative">
//                 <div className="bg-[] flex-col items-start justify-between">
//                   <svg
//                     className="w-9 h-9"
//                     viewBox="0 0 34 32"
//                     fill="none"
...
const WritingStep = () => {
  ...
  return (
    <div className="flex items-center justify-center w-full text-white">
      <div className="max-width items-center  justify-center flex grid-cols-3 base:h-auto h-[360px] py-20 bg-[lue]">
        <div className="w-full h-full flex items-center justify-center border border-[rgba(255,255,255,0.12)] bg-[#111629] rounded-[30px]">
        <div className="bg-[] w-full h-full base:pl-0 relative flex flexcol items-center justify-between pl-10 ">
          <div className="flx flex-col ">
            ...
            <p className="f font-bold text-2xl my-6 large:my-3 ">
              Select writing template
            </p>

            <p className="f text-lg font-normal text-[#747681] largtext-base">
        ...
        <div className="bg-[] h-full w-full base:pl-0 py- relative flex flexcol items-center justify-between pl-10 ">
          <div className="flx flex-col ">
            <svg
              className="w-9 h-9 "
              viewBox="0 0 36 36"
