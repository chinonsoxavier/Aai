  ...
  return (
    <div
      className={`${className} flex items-center  justify-center rounded-full ${
        !borderNone && "p-[1px]"
      } mybutton relative overflow-hidden`}
      style={{
    ...
    >
      <button
        className={` ${
          accent === "light" ? "bg-white text-primary" : "bg-primary"
        } flex items-center flex-1 justify-center z-10 medium:text-[15px] duration-700 mobilex-6 rounded-full px-8 py-3 bg-rimary text-base`}
      >
