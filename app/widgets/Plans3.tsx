...
const Plans3 = () => {
  ...
  return (
    ...
    >
      <div className="flex p-8 gap-5 tablet:flex-col tablet:items-start tablet:p-5 items-center justify-between rounded-lg bg-primary hover:bg-[#111629] duration-500">
