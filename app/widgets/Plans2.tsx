...
const Plans2 = () => {
  ...
  return (
    ...
    >
      <div className="flex p-8 gap-5 tablet:p-5 tablet:flex-col tablet:items-start items-center justify-between rounded-lg bg-primary hover:bg-[#111629] duration-500">
        ...
        <div className="flex-1 max-[160px]">
          <p className="font-bold text-5xl large:text-3xl">$29.99</p>
        </div>
